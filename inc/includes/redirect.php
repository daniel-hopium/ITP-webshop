<div class="text-center login site-font-color my-auto">
  ...
  <img class="mt-4 " src="https://icons.iconarchive.com/icons/iconka/business-finance/256/handshake-icon.png" height="144" alt="Logo">
  ...
  <h1 class=" h6 mb-3 ">Click here <a class="site-font-color" href="<?php echo $destinationPage ?>">here</a>,if you are not Redirected </h1>
