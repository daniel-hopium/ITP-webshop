<div class="text-center login site-font-color my-auto">
  ...
  <h1 class=" h3 mb-3 ">Sie werden in <span class="count">5</span> Sekunden <?php echo $destination ?></h1>
  <h1 class=" h6 mb-3 ">Klicken Sie <a  class="site-font-color" href="<?php echo $destinationPage ?>">hier</a>, falls Sie nicht automatisch weitergeleitet werden</h1>
