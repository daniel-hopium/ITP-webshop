        ...
        <div class="container ">
            <div>
                ...
                <div class="form-floating col-md-12">
                    <input type="text" minlength="4" class="form-control mb-3 shadow" name="newUsername" id="newUsername" placeholder="Neuer Username" required>
                    <label class="" for="newUsername">Neuer Username</label>
                </div>
                <div class="form-floating col-md-12">
                    <input type="text" minlength="4" class="form-control mb-3 shadow" name="confirmUsername" id="confirmUsername" placeholder="Username bestätigen" required>
...
<?php 
    if(isset($_POST["newUsername"]) && isset($_POST["confirmUsername"]))
    {
        ...
        else if(!empty($_POST["newUsername"]) && !empty($_POST["confirmUsername"])) 
        {
        ...
        if ($stmt->execute()) {  echo "<script>location.href='logout.php?'</script>";  } 
                else { echo "Error"; }
