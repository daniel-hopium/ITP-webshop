        ...
        <div class="container ">
            <div>
                ...
                <div class="form-floating col-md-12">
                    <input type="email" class="form-control mb-3 shadow" name="newEmail" id="newEmail" placeholder="Neue Email" required>
                    <label class="" for="newEmail">Neue Email</label>
                </div>
                <div class="form-floating col-md-12">
                    <input type="email" class="form-control mb-3 shadow" name="confirmEmail" id="confirmEmail" placeholder="Email bestätigen" required>
