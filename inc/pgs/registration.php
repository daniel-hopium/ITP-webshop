            ...
            <div class="container ">
                ...
                <div class="row">
                    <div class="form-floating col-md-6">
                        <input type="text" class="form-control mb-3 shadow" name="name" id="name" placeholder="Vorname"
                            required>
                ...
                <div class="row">
                    <div class="form-floating col-md-6">
                        <input type="email" class="form-control mb-3 shadow" name="email" id="email" placeholder="Email"
                            required>
                        <label class="ms-2" for="email">Email</label>
                    </div>
                    <div class="form-floating col-md-6">
                        <input type="email" class="form-control mb-3 shadow" name="emailConfirmation"
                            id="emailConfirmation" placeholder="Email bestätigen" required>
                ...
                <div class="row">
                    <div class="form-floating col-md-6">
                        <input type="password" minlength="8" class="form-control mb-3 shadow" name="password"
                            id="password" placeholder="Passwort" required>
                        <label class="ms-2" for="password">Passwort</label>
                    </div>

                    <div class="form-floating col-md-6">
                        <input type="password" minlength="8" class="form-control mb-3 shadow"
                            name="passwordConfirmation" id="passwordConfirmation" placeholder="Passwort bestätigen"
                            required>
