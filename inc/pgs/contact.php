        ...
        <div class="card card-bg shadow-2-strong card-registration mt-3 p-2 flex-column " style="border-radius: 15px; max-width: 600px;">
            ...
            <form class="" action="contact.php" method="post">
                <div class="form-floating col-md-12 shadow">
                            <input type="text" class="form-control mb-3" name="name" id="floatingName" placeholder="Name" required>
                ...
                <div class="form-floating col-md-12 shadow">
                            <input type="text" class="form-control mb-3" name="subject" id="subject" placeholder="Thema" required>
                            <label class=""for="subject">Thema</label>
                </div>
                <div class="form-floating col-md-12 shadow">
                    <textarea class="form-control mb-3" placeholder="Nachricht" name ="message" id="message" style="height: 100px" required></textarea>
                    <label for="message">Nachricht</label>
                </div>
                <button class="btn btn-primary mb-3 shadow col-md-3 site-font-color" type="submit" name="submit">Abschicken</button>
            </form>
        </div>
    </div>
