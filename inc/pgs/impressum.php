...
<html lang="en">
  ...
  <body class="d-flex flex-column min-vh-100 ">
    <div class="container site-font-color">
      <div class="card card-bg shadow-2-strong card-registration mt-3 p-2 flex-column " style="border-radius: 15px; max-width: 800px;">
        <div>
          <h1 class="ms-3 my-3">Impressum</h1>
        </div>
        
        <ul class="list-group list-group-flush ">
        <li class="list-group-item bg-transparent site-font-color"><h6><b>Hotel Springer</b></h6></li>
          ...
          <li class="list-group-item bg-transparent site-font-color"><a class="site-font-color" href="mailto:info@hotel-springer.de">info@hotel-springer.de</a></li>
        ...
        <ul class="list-group list-group-flush ">
          ...
          <li class="list-group-item bg-transparent site-font-color">Sie können allfällige Beschwerde auch am die oben angegebene E-Mail-Adresse richten.</li>
          <li class="list-group-item bg-transparent site-font-color"></li>
        </ul>
    </div>
    ...
    <div class=" container my-4 ">
      <div class="row mx-1">
        <h3 class="site-font-color">Hotelleitung</h3>
        <div class="col-9 col-md-3 img-fluid">
            <img class="img-fluid" width="200" src="./../..\res\img\impressum-img.jpg">
            <figcaption class="figure-caption site-font-color fw-bold">Daniel Pfeifhofer</figcaption>
        </div>
        <div class="col-9 col-md-3 img-fluid ">
            <img class="img-fluid" width="200" src="./../..\res\img\impressum-img.jpg">
            <figcaption class="figure-caption site-font-color fw-bold">Noohullah Rahmani</figcaption>
        </div>
      </div>
    </div>
  </div>
