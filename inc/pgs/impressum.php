...
<body class="d-flex flex-column min-vh-100 ">
  <div class="container site-font-color">
    <div class="card card-bg shadow-2-strong card-registration mt-3 p-2 flex-column "
      style="border-radius: 15px; max-width: 800px;">
      <div>
      ...
      <ul class="list-group list-group-flush ">
        ...
        <li class="list-group-item bg-transparent site-font-color"><a class="site-font-color"
            href="mailto:info@hotel-springer.de">info@hotel-springer.de</a></li>
      ...
      <ul class="list-group list-group-flush ">
        ...
        <li class="list-group-item bg-transparent site-font-color">Gewerbeordnung: <a class="site-font-color"
            href="www.ris.bka.gv.at">www.ris.bka.gv.at</a></li>
        <li class="list-group-item bg-transparent site-font-color">Bezirkshaupmannschaft Wien</li>
        <li class="list-group-item bg-transparent site-font-color">Verbraucher haben die Möglichkeit, Beschwerden an die
          Online-Streitbeilegungsplattform der EU zu richten: <a class="site-font-color"
            href="http://ec.europa.eu/odr">http://ec.europa.eu/odr</a>.</li>
        <li class="list-group-item bg-transparent site-font-color">Sie können allfällige Beschwerde auch am die oben
          angegebene E-Mail-Adresse richten.</li>
        <li class="list-group-item bg-transparent site-font-color"></li>
      </ul>
    </div>
